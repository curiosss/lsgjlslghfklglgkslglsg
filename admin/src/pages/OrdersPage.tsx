...
export const OrdersPage = () => {
  ...
  const columns = [
    { title: '№', dataIndex: 'order_number', key: 'order_number', width: 120 },
    {
    ...
    { title: 'Сумма', dataIndex: 'total', key: 'total', width: 120, render: (v: number) => formatPrice(v) },
    { title: 'Создан', dataIndex: 'created_at', key: 'created_at', width: 150, render: (v: string) => formatDateTime(v) },
    {
  ...
  return (
    <>
      <h2 style={{ marginBottom: 16 }}>Заказы</h2>
